...
void BallRenderer::renderBalls(Gengine::SpriteBatch& spriteBatch, const std::vector<Ball>& balls,
...
void MomentumBallRenderer::renderBalls(Gengine::SpriteBatch& spriteBatch, const std::vector<Ball>& balls,
    const glm::mat4& projectionMatrix) {
